...
#
#
#                 rrf_files <- file.path(download_path,"META", paste0(tables, ".RRF"))
#                 rrf_files2 <- file.path(download_path,"META", paste0(tables, "2.RRF"))
#                 csv_path <- file.path(download_path, paste0(tables,".csv"))
#                 csv_path2 <- file.path(download_path, paste0(tables,"2.csv"))
#
#                 # Convert
#                 system(paste0("sed 's/\\|/\\,/g' < ", rrf_files, " > ", csv_path))
#                 system(paste0("iconv -c -t utf8 ", csv_path, " > ", csv_path2))
#
#                 system(paste0("iconv -c -t utf8 ", rrf_files, " > ", rrf_files2))
#                 system(paste0("sed 's/\\|/\\,/g' < ", rrf_files2, " > ", csv_path))
#
#
#
#                 system(paste0("sed 's/\\|/\\,/g' < ", rrf_files, " > ", csv_path))
...
#                 system(paste0("sed 's/\\|/\\,/g' < ", rrf_files2, " > ", csv_path))
#
#                 test <- readr::read_csv(file = csv_path,
#                                         quote = "",
#                                         col_names = FALSE,
#                                           n_max = 6)
#                 test2 <- readr::read_csv(file = csv_path2,
#                                         quote = "",
#                                         col_names = FALSE,
#                                         n_max = 6)
#
#                 readr::read_lines(file = csv_path,
#                                 n_max = 6)
#
#
#                 sql <-
#                         SqlRender::render(SqlRender::readSql("inst/sql/pg_copy_semicolon.sql"),
#                                           file = path.expand(csv_path))
#
#                 sql <-
#                         SqlRender::render(SqlRender::readSql("inst/sql/pg_copy_rrf.sql"),
#                                           file = path.expand(rrf_files))
#
#                 conn <- chariot::connectAthena()
#                 pg13::send(conn = conn,
#                            sql_statement = sql)
