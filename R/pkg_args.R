...
#'
#' @param conn          Database connection. For MySQL5.5, the connection made by RMySQL's dbConnect and for Postgres, the connection via DatabaseConnector.
#' @param schema        For Postgres executions only, the schema to write all the tables to, Default: 'mth'
#' @param rrf_dir       Path to directory to the RRF Files either unpackaged by direct download or produced by Metamorphosys
